        ...
        <>
            <div className={styles.container}>
                <div className={styles.headerBlock}>
                   ...
                   <div className={styles.BrandName}>QPICK</div>
                   </Link> 
                    <div className={styles.headerIcons}>
                        <div className={styles.iconWrapper}>
                        <svg width="32" height="34" viewBox="0 0 23 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className={styles.iconWrapper}>
                        <Link to="/bascket">
                        <svg width="32" height="34" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
